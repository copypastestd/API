...
def run(context):
    ...
    try:
        ...
        # Get single profile in the sketch.
        mainCircleProfile = sketch1.profiles.item(0)         
        
        # Create an extrudeInput        
        extrudes = rootComp.features.extrudeFeatures
        mainExtrudeInput = extrudes.createInput(mainCircleProfile, adsk.fusion.FeatureOperations.NewBodyFeatureOperation)
        ...
        mainExtrudeInput.setDistanceExtent(False, distanceMainExtrude)
        # Creating the extrusion
        mainExtrude = extrudes.add(mainExtrudeInput)
